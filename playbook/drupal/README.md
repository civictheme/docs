# CivicTheme Playbook: Drupal Community
...
1. **[Installation](01-installation.md)** — Install CivicTheme via Composer, enable required modules, generate your sub-theme, build assets, and provision content.
...
7. **[Security Updates](../shared/07-security-updates.md)** — Subscribe to security advisories, assess severity, and apply patches to your Drupal site.
